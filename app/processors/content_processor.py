...
class ContentProcessor:
    ...
    def process_pdf_docx(self, file_path: str) -> str:
        try:
    ...
    def process_web_url(self, url: str) -> str:
        try:
    ...
    def process_audio_video(self, file_path: str) -> str:
        try:
            if not file_path.endswith('.wav'):
                file_path = self.convert_audio_to_wav(file_path)
            
            transcription = self.whisper_model.transcribe_audio(file_path)
