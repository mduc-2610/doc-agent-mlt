...
app.include_router(tutor_routes.router, prefix="/tutor", tags=["Tutor Generation"])
...
async def clear_cache():
    try:
        cleared_count = vector_processor.cleanup_cache()
        return {
            "message": f"Cleared {cleared_count} cached embeddings",
